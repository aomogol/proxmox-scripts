...
export VM_ID="8003"
export VM_NAME="ubuntu-24.04-cloudimg"
...
export VM_OS_VARIANT="noble"
export VM_OS_VERSION="24.04"
export VM_OS_ARCH="amd64"
export VM_OS_CLOUD_INIT_FILE="cloud-init.iso"
export VM_OS_CLOUD_INIT_PATH="/var/lib/libvirt/images"
export VM_OS_CLOUD_INIT_ISO_URL="https://cloud-images.ubuntu.com/noble/current/noble-server-cloudimg-amd64.img"
export VM_OS_CLOUD_INIT_ISO_FILE="noble-server-cloudimg-amd64.img"
