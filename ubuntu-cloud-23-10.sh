...
export VM_ID="8004"
export VM_NAME="ubuntu-23.10-cloudimg"
...
export VM_OS_VARIANT="mantic"
export VM_OS_VERSION="23.10"
export VM_OS_ARCH="amd64"
export VM_OS_CLOUD_INIT_FILE="cloud-init.iso"
export VM_OS_CLOUD_INIT_PATH="/var/lib/libvirt/images"
export VM_OS_CLOUD_INIT_ISO_URL="https://cloud-images.ubuntu.com/mantic/current/mantic-server-cloudimg-amd64.img"
export VM_OS_CLOUD_INIT_ISO_FILE="mantic-server-cloudimg-amd64.img"
