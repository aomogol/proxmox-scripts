...
export VM_ID="8011"
export VM_NAME="ubudebian-13-cloudimg"
...
export VM_OS_VERSION="13"
export VM_OS_ARCH="amd64"
export VM_OS_CLOUD_INIT_FILE="cloud-init.iso"
export VM_OS_CLOUD_INIT_PATH="/var/lib/libvirt/images"
export VM_OS_CLOUD_INIT_ISO_URL="https://cloud.debian.org/images/cloud/trixie/daily/latest/debian-13-genericcloud-amd64-daily.qcow2"
export VM_OS_CLOUD_INIT_ISO_FILE="debian-13-genericcloud-amd64-daily.qcow2"
